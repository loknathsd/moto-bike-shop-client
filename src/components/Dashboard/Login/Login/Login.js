    ...
    return (
        <section>
            ...
            <div className='container text-center mt-5 pt-5'>
                <div className='shadow p-5 ' style={{ width: '50%', margin: 'auto' }}  >
                    ...
                    <h4>OR</h4>
                    <button onClick={handleGoogleSignIn} className='btn btn-outline-secondary form-control fw-bold'><FontAwesomeIcon style={{ color: 'red', marginRight: '50px' }} icon={faGoogle} size='2x' /> <span style={{ fontSize: '25px' }}>SignIn with Google</span></button>
                </div>
            </div>
        </section>
    );
